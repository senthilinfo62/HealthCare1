...
import com.cloudifive.healthcare.Adapter.DepartmentsAdapter;
...
public class DepartmentsFragment extends Fragment {
    ...
    List<Departments> modelsModelNews = new ArrayList<>();
    private DepartmentsAdapter nAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nAdapter = new DepartmentsAdapter(modelsModelNews,getActivity());
...
//        HomeMenuHelper.INSTANCE.
        HomeMenuHelper.INSTANCE.getDepartments().continueWith(new Continuation<JSONObject, Void>() {
            @Override
            public Void then(Task<JSONObject> task) {
                ...
                try {
                    ...
                    JSONArray jsonArray = new JSONArray(menuResponse.getJSONArray("get_department").toString());
                    for (int i=0;i<jsonArray.length();i++)
                    {
                        JSONObject jsonObject=jsonArray.getJSONObject(i);
                        String name=jsonObject.getString("title");
                        String description=jsonObject.getString("description");
                        Departments modelNews = new Departments("",name,description,"","");
