...
import com.cloudifive.healthcare.Adapter.OffersAdapter;
...
public class OffersFragment extends Fragment {
    ...
    List<Offers> modelsModelNews = new ArrayList<>();
    private OffersAdapter nAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nAdapter = new OffersAdapter(modelsModelNews,getActivity());
...
//        HomeMenuHelper.INSTANCE.
        HomeMenuHelper.INSTANCE.getOffers().continueWith(new Continuation<JSONObject, Void>() {
            @Override
            public Void then(Task<JSONObject> task) {
                ...
                try {
                    ...
                    JSONArray jsonArray = new JSONArray(menuResponse.getJSONArray("get_Offer").toString());
                    for (int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        Offers modelNews = new Offers(title,price,start_date,end_date,description);
