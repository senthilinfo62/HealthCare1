...
import com.cloudifive.healthcare.Adapter.FacilitiesAdapter;
...
public class FacilitiesFragment extends Fragment {
    ...
    List<Facilities> modelsModelNews = new ArrayList<>();
    private FacilitiesAdapter nAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nAdapter = new FacilitiesAdapter(modelsModelNews,getActivity());
...
//        HomeMenuHelper.INSTANCE.
        HomeMenuHelper.INSTANCE.getFacilities().continueWith(new Continuation<JSONObject, Void>() {
            @Override
            public Void then(Task<JSONObject> task) {
                ...
                try {
                    ...
                    JSONArray jsonArray = new JSONArray(menuResponse.getJSONArray("get_Facility").toString());
                    for (int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        Facilities modelNews = new Facilities("",name,description,image,"");
