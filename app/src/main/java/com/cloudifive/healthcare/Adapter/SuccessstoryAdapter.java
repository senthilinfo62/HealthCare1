...
public class SuccessstoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ArrayList<SuccessStory> myHisJbItem;
    Dialog myPreviewDialog;
    private LayoutInflater inflater;
    private Context myCtx;

    public SuccessstoryAdapter(Context context, ArrayList<SuccessStory> items) {
        myCtx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.card_sucessstory, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        try {
            SuccessStory aItem = myHisJbItem.get(position);
