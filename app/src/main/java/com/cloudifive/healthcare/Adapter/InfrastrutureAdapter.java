...
public class InfrastrutureAdapter extends RecyclerView.Adapter<InfrastrutureAdapter.CustomViewHolder> {
    private Context mContext;
    private List<Infrastructure> modelNews;
    int myPosition;

    public InfrastrutureAdapter(List<Infrastructure> modelNews, Context mContext) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Infrastructure aItem = modelNews.get(position);
            myPosition = position;
            switch (v.getId()) {
                case R.id.mycard:
